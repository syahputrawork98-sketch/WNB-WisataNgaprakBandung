...
4. **Menyambut Berbagai Peserta:** Mengakomodasi peserta pemula yang mencari pengalaman aman, sekaligus menarik peserta yang kembali untuk tantangan berbeda.
5. **Transparansi Operasional:** Menginformasikan basis administrasi dan titik temu yang fleksibel.
...
8. **AdventureForEveryoneSection:** Menegaskan bahwa WNB cocok untuk perjalanan pertama dan tantangan berikutnya.
9. **OperationalBaseSection:** Informasi kantor administrasi dan garasi unit cadangan di Cimahi.
...
- **Fakta terverifikasi:** Alamat Cimahi ditegaskan hanya sebagai basis operasional dan garasi cadangan, bukan sebagai titik temu utama yang kaku.
- **Tidak ada istilah TBD** atau data fiktif pada antarmuka publik. Bagian visual masih memakai layout placeholder hingga aset foto aslinya tersedia, tetapi konten teks seluruhnya faktual.
